...
{
    #[Route('/', name: 'app_admin_like_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_admin_like_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_like_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('admin/like/new.html.twig', [
            'like' => $like,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_like_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_admin_like_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Like $like, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('admin/like/edit.html.twig', [
            'like' => $like,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_like_delete', methods: ['POST'])]
